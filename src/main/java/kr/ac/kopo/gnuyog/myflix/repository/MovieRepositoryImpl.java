...
public class MovieRepositoryImpl implements MovieRepository
{
    ...
    private Long nextId; // 선언만, save() 첫 호출 때 자동 계산
    ...
    public void init()
    {
        Object[][] data = {
                ...
                { 37L, "밴드 오브 브라더스",     "드라마",    "2차 세계대전 노르망디 상륙작전부터 종전까지, E중대 낙하산 부대원들의 실화를 담은 HBO 10부작.",        "https://image.tmdb.org/t/p/w500/acAoCCasY6ei0hTXbC9Yc8DCYfT.jpg", 2001 },
                ...
                { 24L, "더 소셜 딜레마",         "다큐멘터리","소셜 미디어가 어떻게 인간의 심리를 조작하고 사회를 분열시키는지 내부자들이 고발하는 다큐.",            "https://image.tmdb.org/t/p/w500/2q6RtFRMrlP4iEBUKH0Wsl6c3e0.jpg", 2020 },
    ...
    {
        // nextId가 null이면 현재 최대 ID + 1로 자동 계산
        if (nextId == null)
        {
            long maxId = 0;
            for (Movie m : movies)
