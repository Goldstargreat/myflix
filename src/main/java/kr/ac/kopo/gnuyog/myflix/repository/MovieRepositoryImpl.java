...
public class MovieRepositoryImpl implements MovieRepository
{
    ...
    public void init()
    {
        ...
        movies.add(new Movie(4L,  "조커",                  "영화", "아서 플렉이 조커가 되어가는 과정을 그린 심리 스릴러. 호아킨 피닉스의 열연.",                               "https://image.tmdb.org/t/p/w500/udDclJoHjfjb8Ekgsd4FDteOkCU.jpg", 2019, 0.0));
        ...
        movies.add(new Movie(7L,  "아버지의 깃발",          "영화", "이오지마 전투에서 성조기를 꽂은 병사들의 이야기를 미국 시각에서 그린 클린트 이스트우드의 전쟁 영화.",   "https://image.tmdb.org/t/p/w500/bDFMFMKFUMJtSHHNMYlBBNFDQoA.jpg", 2006, 0.0));
        movies.add(new Movie(9L,  "오펜하이머",             "영화", "원자폭탄의 아버지 오펜하이머의 삶과 그 무게를 담은 크리스토퍼 놀란의 역작.",                             "https://image.tmdb.org/t/p/w500/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg", 2023, 0.0));
        ...
        movies.add(new Movie(15L, "쇼생크 탈출",            "영화", "억울하게 수감된 앤디 듀프레인의 희망과 탈출을 그린 불후의 명작.",                                         "https://image.tmdb.org/t/p/w500/lyQBXzOQSuE59IsHyhrp0qIiPAz.jpg", 1994, 0.0));
        movies.add(new Movie(16L, "포레스트 검프",           "영화", "평범하지 않은 삶을 살아온 포레스트 검프의 일생을 통해 미국 현대사를 돌아보는 감동 영화.",              "https://image.tmdb.org/t/p/w500/arw2vcBveWOVZr6pxd9XTd1TdQa.jpg", 1994, 0.0));
        movies.add(new Movie(17L, "1917",                   "영화", "1차 세계대전, 단 두 명의 병사가 수천 명을 구하기 위해 적진을 가로질러 달리는 원테이크 전쟁 영화.",     "https://image.tmdb.org/t/p/w500/iZf0KyrE25z1sage4SYFLCCrMi9.jpg", 2019, 0.0));

        // ─── TV 드라마 ──────────────────────────────────────────
        movies.add(new Movie(31L, "스파르타쿠스",           "드라마", "검투사 스파르타쿠스가 로마의 노예 제도에 맞서 대반란을 이끄는 역사 액션 드라마.",                        "https://image.tmdb.org/t/p/w500/kJJSQTaTWy0rvzFgjHKJEMB4gIb.jpg", 2010, 0.0));
        movies.add(new Movie(32L, "셜록",                   "드라마", "현대 런던을 배경으로 한 셜록 홈즈의 재해석. BBC의 베네딕트 컴버배치 주연 명작.",                         "https://image.tmdb.org/t/p/w500/7WTsnHkbA0FaG6R9twfFde0I9hl.jpg", 2010, 0.0));
        movies.add(new Movie(33L, "브레이킹 배드",           "드라마", "암 선고를 받은 화학 교사가 마약 제조왕으로 변해가는 AMC의 전설적인 드라마.",                           "https://image.tmdb.org/t/p/w500/ggFHVNu6YYI5L9pCfOacjizRGt.jpg", 2008, 0.0));
        movies.add(new Movie(34L, "왕좌의 게임",             "드라마", "왕좌를 둘러싼 귀족 가문들의 권력 다툼과 판타지 세계를 그린 HBO 대서사 드라마.",                         "https://image.tmdb.org/t/p/w500/1XS1oqL89opfnbLl8WnZY1O1uJx.jpg", 2011, 0.0));
        movies.add(new Movie(35L, "오징어 게임",             "드라마", "456억 원을 걸고 목숨을 건 서바이벌 게임에 참가한 사람들의 이야기. 넷플릭스 역대 1위.",                  "https://image.tmdb.org/t/p/w500/dDlEmu3EZ0Pgg93K2SVNLCjCSvE.jpg", 2021, 0.0));
        movies.add(new Movie(36L, "체르노빌",               "드라마", "1986년 체르노빌 원전 폭발 사고의 진실을 파헤치는 HBO 미니시리즈.",                                       "https://image.tmdb.org/t/p/w500/hlLXt2tOPT6RRnjiUmoxyG1LTFi.jpg", 2019, 0.0));
